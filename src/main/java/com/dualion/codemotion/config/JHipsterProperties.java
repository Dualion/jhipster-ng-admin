package com.dualion.codemotion.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "codemotion@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "codemotion API";

        private String description = "codemotion API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "codemotion";
